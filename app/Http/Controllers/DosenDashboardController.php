...
class DosenDashboardController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dosendashboard')->with('success','Data berhasil ditambahkan');
    }
    ...
    public function update(Request $request, Dosen $dosen,$id)
    {
        ...
        return redirect('/dosendashboard')->with('success','Data berhasil diubah');
    }
    ...
    {
        Dosen::destroy($id);
        return redirect('/dosendashboard')->with('success','Data berhasil dihapus');
    }
}
