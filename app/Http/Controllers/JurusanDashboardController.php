...
class JurusanDashboardController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/jurusandashboard')->with('success','Data berhasil ditambahkan');
    }
    ...
    public function update(Request $request, Jurusan $jurusan,$id)
    {
        ...
        return redirect('/jurusandashboard')->with('success','Data berhasil diubah');
    }
    ...
    {
        Jurusan::destroy($id);
        return redirect('/jurusandashboard')->with('success','Data berhasil dihapus');
    }
}
